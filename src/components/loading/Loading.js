const Loading = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" style={{margin: '0 auto', background: 'rgb(255, 255, 255)', display: 'block'}} width="224px" height="224px" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
      <g transform="rotate(0 50 50)">
        <rect x="49.5" y="25.5" rx="0" ry="0" width="1" height="11" fill="#6c4f2f">
